						...
						<ul>
							<li class="animated fadeInRight">
								<a href="message2.html">
									...
									<div class="messdiv">
										<div class="mess_t"><span><a href="<?php echo U('Article/detail?id='.$data['id']);?>"><?php echo ($data["title"]); ?></a></span><font class="color_g puff_right"><?php echo (date('Y-m-d H:i',$data["create_time"])); ?></font></div>
										<div class="mess_b">
